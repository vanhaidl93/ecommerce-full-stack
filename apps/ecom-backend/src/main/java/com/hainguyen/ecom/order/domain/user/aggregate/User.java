...
/*
 * contain all the fields and some validation, some business logic.
 * */
@Builder
public class User {
  ...
  private void assertMandatoryFields(){
    Assert.notNull("lastname",this.lastname);
    Assert.notNull("firstname",this.firstname);
    Assert.notNull("email",this.email);
    Assert.notNull("authorities",this.authorities);
  }
