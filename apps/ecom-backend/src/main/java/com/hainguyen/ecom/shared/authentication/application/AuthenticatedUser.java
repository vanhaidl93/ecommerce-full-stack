...
import com.hainguyen.ecom.shared.authentication.domain.Role;
import com.hainguyen.ecom.shared.authentication.domain.Roles;
import com.hainguyen.ecom.shared.authentication.domain.Username;
...
/*
 * This is the utility class to get authenticated user information
 * include java docs
 * */
public class AuthenticatedUser {
  ...
  public static String readPrincipal(Authentication authentication) {
    ...
    if (authentication.getPrincipal() instanceof UserDetails details) {
      return details.getUsername(); // principal equivalent to username
    }
